...
rectangle12_22 = make_rectangle(12,18,22,90,124)
rectangle12_24 = make_rectangle(12,18,24,90,124)
rectangle11_22 = make_rectangle(11,18,22,90,124)
rectangle11_24 = make_rectangle(11,18,24,90,124)
line = Line(0 + 0j, 300 + 200j)
zigzag = make_zigzag_column(15,40,200,0,0)
shaped_paths = crop_and_rotate_to_shape(circle, rectangle11_22, True, 30)
...
wsvg(paths=rectangle12_22, filename='../output/rectangle12_22.svg', baseunit="mm")
wsvg(paths=rectangle11_24, filename='../output/rectangle11_24.svg', baseunit="mm")
wsvg(paths=rectangle11_22, filename='../output/rectangle11_22.svg', baseunit="mm")
wsvg(paths=rectangle12_24, filename='../output/rectangle12_24.svg', baseunit="mm")
